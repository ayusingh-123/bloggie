<x-app-layout>
    ...
    <div style="display: flex; flex-direction: column;">
        <div style="max-width: 50rem; margin: 0 auto; padding: 1rem 2rem;">
            ...
            <h1 style="font-weight: 600; font-size: 1.5rem;">Edit Post</h1>
                ...
                <div style="padding: 2rem;">
                    <form class="w-full max-w-sm" method="POST">
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 0.5rem;">
                                ...
                                <div style="margin-right:440px;margin-top:-0.1rem; align-items: center;">
                                    <input value="{{$post->title}}" style="border: 2px solid #ccc; border-radius: 0.25rem; width: 100%; padding: 0.5rem 1rem;" id="title" type="text" name="title">
                                </div>
                            </div>
                            ...
                            <div style="display: flex; align-items: center; margin-top: 2rem;">
                                ...
                                <div style="flex: 2; margin-right:310px; margin-top:-0.1rem; width:20rem;">
                                    <textarea style="resize: vertical; border: 2px solid #ccc; border-radius: 0.25rem; width: 22rem;" name="body">{{$post->body}}</textarea>
                                </div>
                            </div>
